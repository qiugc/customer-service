...
available_setting = {
    ...
    "model": "DOUBAO_AI",  # 可选择: gpt-4o, pt-4o-mini, gpt-4-turbo, claude-3-sonnet, wenxin, moonshot, qwen-turbo, xunfei, glm-4, minimax, gemini等模型，全部可选模型详见common/const.py文件
    ...
    # 豆包AI 平台配置
    "doubao_ai_api_key": "0ad521e8-722b-4177-b316-f556efd0faf3",
    "doubao_ai_api_base": "https://ark.cn-beijing.volces.com/api/v3/chat/completions",
